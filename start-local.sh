...
CALLER_ROLE_ENV_NAMES=(
  ...
  LLM_SCRIPT_ALTERNATE_SEND_RESPONSE_FORMAT
...
export LLM_SCRIPT_REASONING_EFFORT="${LLM_SCRIPT_REASONING_EFFORT:-medium}"
export LLM_SCRIPT_THINKING_MODE="${LLM_SCRIPT_THINKING_MODE:-}"
...
STORY_ARCHITECT_TIMEOUT="${LLM_STORY_ARCHITECT_TIMEOUT_SECONDS:-$LLM_PLANNING_TIMEOUT_SECONDS}"
STORY_ARCHITECT_RETRIES="${LLM_STORY_ARCHITECT_MAX_RETRIES:-$LLM_PLANNING_MAX_RETRIES}"
...
echo "Episode roadmap model: $EPISODE_PLAN_MODEL wire_api=$EPISODE_PLAN_WIRE_API strict_schema=$EPISODE_PLAN_STRICT reasoning=$EPISODE_PLAN_REASONING"
...
echo "Script body limit: ${LLM_SCRIPT_TIMEOUT_SECONDS}s, retries=${LLM_SCRIPT_MAX_RETRIES}, reasoning=${LLM_SCRIPT_REASONING_EFFORT:-provider_default}, thinking=${LLM_SCRIPT_THINKING_MODE:-provider_default}"
