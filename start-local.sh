...
CALLER_ROLE_ENV_NAMES=(
  ...
  LLM_STORY_ARCHITECT_RECOVERY_PROVIDER LLM_STORY_ARCHITECT_RECOVERY_MODEL
  LLM_STORY_ARCHITECT_RECOVERY_API_KEY LLM_STORY_ARCHITECT_RECOVERY_BASE_URL
  LLM_STORY_ARCHITECT_RECOVERY_WIRE_API
  LLM_STORY_ARCHITECT_RECOVERY_REASONING_EFFORT
  LLM_STORY_ARCHITECT_RECOVERY_THINKING_MODE
  LLM_STORY_ARCHITECT_RECOVERY_TIMEOUT_SECONDS
  LLM_STORY_ARCHITECT_RECOVERY_MAX_RETRIES
  LLM_STORY_ARCHITECT_RECOVERY_USE_STRICT_SCHEMA
  LLM_STORY_ARCHITECT_RECOVERY_SEND_RESPONSE_FORMAT
  LLM_STORY_ARCHITECT_RECOVERY_RETRY_EMPTY_RESPONSE
  LLM_STORY_ARCHITECT_FALLBACK_PROVIDER LLM_STORY_ARCHITECT_FALLBACK_MODEL
  LLM_STORY_ARCHITECT_FALLBACK_API_KEY LLM_STORY_ARCHITECT_FALLBACK_BASE_URL
  LLM_STORY_ARCHITECT_FALLBACK_WIRE_API
  LLM_STORY_ARCHITECT_FALLBACK_REASONING_EFFORT
  LLM_STORY_ARCHITECT_FALLBACK_THINKING_MODE
  LLM_STORY_ARCHITECT_FALLBACK_TIMEOUT_SECONDS
  LLM_STORY_ARCHITECT_FALLBACK_MAX_RETRIES
  LLM_STORY_ARCHITECT_FALLBACK_USE_STRICT_SCHEMA
  LLM_STORY_ARCHITECT_FALLBACK_SEND_RESPONSE_FORMAT
  LLM_STORY_ARCHITECT_FALLBACK_RETRY_EMPTY_RESPONSE
  ...
  LLM_SCRIPT_ADAPTIVE_NON_STREAM_THRESHOLD
  LLM_SCRIPT_ADAPTIVE_NON_STREAM_COOLDOWN_SECONDS
  LLM_SCRIPT_CIRCUIT_FAILURE_THRESHOLD LLM_SCRIPT_CIRCUIT_COOLDOWN_SECONDS
  ...
  LLM_SCRIPT_ALTERNATE_02_PROVIDER LLM_SCRIPT_ALTERNATE_02_MODEL
  LLM_SCRIPT_ALTERNATE_02_API_KEY LLM_SCRIPT_ALTERNATE_02_BASE_URL
  LLM_SCRIPT_ALTERNATE_02_WIRE_API LLM_SCRIPT_ALTERNATE_02_REASONING_EFFORT
  LLM_SCRIPT_ALTERNATE_02_THINKING_MODE LLM_SCRIPT_ALTERNATE_02_TIMEOUT_SECONDS
  LLM_SCRIPT_ALTERNATE_02_MAX_RETRIES LLM_SCRIPT_ALTERNATE_02_USE_STRICT_SCHEMA
  LLM_SCRIPT_ALTERNATE_02_SEND_RESPONSE_FORMAT LLM_SCRIPT_ALTERNATE_02_RETRY_EMPTY_RESPONSE
...
# Preserve any explicitly exported market-route overrides without maintaining
# another long list whenever a new market role flag is added.
while IFS= read -r _role_env_name; do
  case "$_role_env_name" in
    LLM_CN_*|LLM_OVERSEAS_*)
      _caller_role_var="CALLER_${_role_env_name}"
      printf -v "${_caller_role_var}" '%s' "${!_role_env_name:-}"
      ;;
  esac
