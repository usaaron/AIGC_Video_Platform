...
> 最新生产修复：2026-09-21 01:01:02（上海时间），剧本 API / Web `e71ee9874823` 与主站 Web `2cc67d2b591b` 已上线。修复新网剧快速入口及 PostgreSQL 生成保存误报冲突，实际镜像、备份和验证边界见 [修复发布记录](POSTGRES_GENERATION_SAVE_FIX_2026-09-21.md#生产发布与验证)。

> 2026-09-21 发布更新：用户确认的 5182 融合版已配套上线，剧本业务提交 `5f41a27`、主站 `ebb55fa`。当前版本、模型配置与验收边界见 [生产发布记录](PRODUCTION_2026-09-21.md)。下方未发布说明为本次发布前的历史记录。
