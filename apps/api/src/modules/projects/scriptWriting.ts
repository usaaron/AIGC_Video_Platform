...
- 正文前固定输出“资产：”，资产清单结束后输出“正文：”。每个稳定实体单独一行，名称后使用“｜”补充可复用设定：人物写“人物：角色名｜性别：按原稿｜年龄段：按原稿｜年龄：按原稿｜身份：按原稿｜体型：具体体型｜脸型：具体脸型｜发型：具体发色与长度｜肤色：具体肤色｜基础造型：符合身份的造型”；场景写“场景：名称｜空间：室外｜时代：现代｜场景用途：通行巷道｜固定布局：狭窄直巷｜入口出口：南口、北口｜固定陈设：右侧雨棚、巷尾卷帘门｜材质：旧砖墙和湿水泥地｜基础色彩：冷灰绿”；物品写“物品：名称｜分类：容器｜尺度：手掌大小｜形状：长方体｜材质：金属｜颜色：暗灰｜固定结构：暗扣盒盖｜基础状态：旧但完整｜归属：原稿所属角色名｜准确文字：无”；服装写“服装：名称｜归属：原稿所属角色名｜时代：现代｜季节：秋冬｜剪裁：短款｜层次：单层外套｜颜色：深灰｜材质：防水布｜配件：无”；品牌写“品牌：名称｜准确文字：名称｜图形结构：文字标｜字体方向：横排｜标准色：黑白｜版式背景：透明背景”。没有的类别不要输出。
...
- 网剧人物每个稳定造型单独一行，仍归属于同一基础人物，格式示例：“人物：原稿角色名-标准版｜基础人物：原稿角色名｜版本：标准版｜身份：原稿身份｜外形：符合原稿的具体外形｜服装：符合原稿的材质、剪裁与配色”。有明确换装才增加“原稿角色名-具体服装版”等行；不要为每一集自动创造新造型。网剧不单列服装资产；广告、短片需要独立服装设计时可单列。
