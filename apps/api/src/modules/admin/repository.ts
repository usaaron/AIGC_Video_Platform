...
import {
  ...
  complianceRiskScore,
  isComplianceRiskCategory,
  promptTextFromComplianceRow,
} from './complianceClassifier.js'
import {
  hasAdminRole,
  hasElevatedRole,
...
export { classifyComplianceRisk } from './complianceClassifier.js'
...
function complianceCategoryOrNull(value: unknown): AdminComplianceRiskCategory | null {
  return isComplianceRiskCategory(value) ? value : null
}
