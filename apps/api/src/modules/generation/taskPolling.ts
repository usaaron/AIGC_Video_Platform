...
const generationTaskPollingColumns = `
  ...
  jsonb_strip_nulls(jsonb_build_object(
    ...
    'compositionStage', metadata->'compositionStage',
    'continuityMode', metadata->'continuityMode',
    'continuitySourceTaskId', metadata->'continuitySourceTaskId',
    'creditsRefundedAt', metadata->'creditsRefundedAt',
    'duration', metadata->'duration',
    'episodeId', metadata->'episodeId',
    'episodeNumber', metadata->'episodeNumber',
    'generationStage', metadata->'generationStage',
    'image2BatchId', metadata->'image2BatchId',
    'localTaskStartedAt', metadata->'localTaskStartedAt',
    'mode', metadata->'mode',
    'previewMode', metadata->'previewMode',
    'providerFailureCode', metadata->'providerFailureCode',
    'providerFailureSource', metadata->'providerFailureSource',
    'providerName', metadata->'providerName',
    'providerPollErrors', metadata->'providerPollErrors',
    'providerPollRetryNotBefore', metadata->'providerPollRetryNotBefore',
    'providerProgressIsEstimated', metadata->'providerProgressIsEstimated',
    'providerReconciliationReason', metadata->'providerReconciliationReason',
    'providerReconciliationStatus', metadata->'providerReconciliationStatus',
    'providerReconciliationHistoryOnly', metadata->'providerReconciliationHistoryOnly',
    'providerSubmittedAt', metadata->'providerSubmittedAt',
    'providerState', metadata->'providerState',
    'referenceAssetIds', metadata->'referenceAssetIds',
    'resolution', metadata->'resolution',
    'revisionNote', metadata->'revisionNote',
    'scriptOperation', metadata->'scriptOperation',
    'shotId', metadata->'shotId',
    'sourceScriptFingerprint', metadata->'sourceScriptFingerprint',
    'textPreview', metadata->'textPreview',
    'textPreviewStage', metadata->'textPreviewStage',
    'textPreviewValidation', metadata->'textPreviewValidation',
    'textTiming', metadata->'textTiming',
    'turnaround', metadata->'turnaround'
  )) AS metadata,
  status,
  progress,
  estimated_credits,
...
const POLLING_METADATA_KEYS = [
  ...
  'providerName',
  'providerPollErrors',
  'providerPollRetryNotBefore',
  'providerProgressIsEstimated',
  'providerReconciliationReason',
  'providerReconciliationStatus',
  'providerReconciliationHistoryOnly',
  'providerSubmittedAt',
  'providerState',
  'referenceAssetIds',
  'resolution',
