...
export async function registerLibraryRoutes(
  ...
  app.post(
    ...
    async (request, reply) => {
      ...
      return reply
        .code(201)
        .send(await service.addVersion(params.data.itemId, parsed.data, request.principal!))
    },
  )
  ...
  app.post(
    ...
    async (request, reply) => {
      ...
      return reply
        .code(201)
        .send(await service.importToProject(params.data.projectId, parsed.data, request.principal!))
    },
  )
