  ...
  const store =
    ...
    new AppStore(
      options.config.DATA_FILE === ':memory:' ? null : resolve(options.config.DATA_FILE),
      {
        ...
        superAdminName: options.config.BOOTSTRAP_SUPER_ADMIN_NAME,
        superAdminEmail: options.config.BOOTSTRAP_SUPER_ADMIN_EMAIL,
        superAdminPassword: options.config.BOOTSTRAP_SUPER_ADMIN_PASSWORD,
