      ...
      <section className="image2-panel image2-composer" aria-label="提示词编排">
        ...
        <div className="image2-composer-foot">
          ...
          <div className="image2-composer-actions">
            <div
              className={`image2-submit-summary ${summaryWarning ? 'warning' : ''}`}
              aria-label={`预计 ${estimatedCredits} / 可用 ${availableCredits}`}
            >
              <span>预计</span>
          ...
          >
            ...
            <div className="image2-submit-confirm-body">
              <p className="image2-submit-confirm-copy">
                本次将生成 <strong>{imageCount}</strong> 张图片，预计消耗 <strong>{estimatedCredits}</strong>{' '}
                积分， 当前余额 <strong>{availableCredits}</strong> 积分。
              </p>
