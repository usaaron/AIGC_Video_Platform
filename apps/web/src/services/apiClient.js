...
export const api = {
  ...
  updateLibraryItem: (itemId, input) => request(`/library/items/${encodeURIComponent(itemId)}`, json('PATCH', input)),
  deleteLibraryItem: (itemId) => request(`/library/items/${encodeURIComponent(itemId)}`, { method: 'DELETE' }),
