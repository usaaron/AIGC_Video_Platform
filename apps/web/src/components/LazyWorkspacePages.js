...
export const RechargePage = lazyNamed(() => import('../pages/RechargePage'), 'RechargePage')
export const MembershipPage = lazyNamed(() => import('../pages/MembershipPage'), 'MembershipPage')
